...
export class Cake_Physics extends Scene {
  constructor() {
    ...
    this.shapes = {
      ...
      notebook: new Model("../asset/notebook.obj")
    };
  ...
  initialize_objects() {
    ...
    this.objects = [
      [
        new Object({shape: this.shapes.lamp, material: this.materials.normal, 
          position: vec3(0,0,0), 
          rotation_model: vec3(2.0, 2.0, -4.0),
          scale: vec3(1.0,1.0,1.0), mass: get_mass(scales[0]),
          color: color(...array_random(0.0, 1.0), 1.0),
        })
      ],
      [
        new Object({shape: this.shapes.notebook, material: this.materials.normal, 
          position: vec3(0,0,0), 
      ...
      [
        new Object({shape: this.shapes.bookcase, material: this.materials.normal, 
          position: vec3(0,0,0), 
      ...
      [
        new Object({
          ...
          scale: vec3(1.5,1.5,1.5), mass: get_mass(scales[0]),
          color: color(...array_random(0.0, 1.0), 1.0),
        })
      ],
    ];
