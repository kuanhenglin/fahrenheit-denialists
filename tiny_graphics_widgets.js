/**
 * @file
 * This file defines a lot of panels that can be placed on websites to create interactive graphics programs that use tiny_graphics.js.
 */

import {tiny} from './tiny_graphics.js';
...
const Code_Widget = widgets.Code_Widget =
    class Code_Widget {
        ...
        build_navigator(element, main_scene, additional_scenes, definitions) {
            ...
            content.innerHTML = "main_scene.js<br>Main Scene: ";
            ...
            third_row.innerHTML = "<td><b>tiny_graphics.js</b><br>(Always the same)</td> \
